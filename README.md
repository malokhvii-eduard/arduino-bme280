...
Download the library as a ZIP from release assets. Once downloaded, go to the
Arduino IDE and click `Sketch > Include Library > Add .zip Library`. In the
file dialogue that opens, locate your downloaded ZIP file. Afterward, you
should receive a “Library Added” message just above the debug window.
Enjoy! :tada::+1:
...
- [four-wire.ino](examples/four-wire/four-wire.ino) &ndash; read temperature,
